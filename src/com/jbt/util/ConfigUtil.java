...
public class ConfigUtil {
	...
	//private final static long valid = 3 * 60 * 60 * 1000;//3小时
	private final static long valid = 3 * 24 * 60 * 60 * 1000;//3天
	 ...
	 * @return
	 */
	public static String getGuidValid(){
		return DateUtil.getCurrentDate(DateUtil.DATE_FORMAT_3,new Date().getTime() + valid);
	}
	/**
	 * 判断GUID是否超时
	 */
	public static boolean isTimeOut(String valid){
		if(valid.compareTo(DateUtil.getNow()) <= 0){
			return true;
		}
		return false;
	}
	 ...
	 * @return
	 */
	public static boolean checkParamIsNull(String array[]){
    ...
    public static boolean isCanBeInt(String num){
     ...
     * @return
     */
    public static boolean isCanBeFloat(String num){
    	if(num!=null && num.matches("[\\d]+")){
    		return true;
    	}
