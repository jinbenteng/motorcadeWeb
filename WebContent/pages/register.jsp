...
<link rel="stylesheet" type="text/css" href="<%=basePath%>pages/css/reg.css" />
<script src="<%=basePath%>pages/js/jquery-1.8.1.min.js" type="text/javascript"></script>  
</head>
<body class="reg-main">
    <div class="reg-wrap">
     <form id="form" action="<%=basePath%>manager_add" method="post" class="reg-form">
        <div class="reg-telValidate" >
        	<p style="font-size:16px; color:#999">手机号验证:</p>  
            <div style="width:100%; height:2px; background:#ccc;"></div>
            <div  class="reg-userinfo-tel">   
            	<p style="width:25%; height:70%;float:left;text-align:right">手机号码:</p>
                <input class = "input_tel" type="tel" name="tel" style=" required="required" placeholder="请输入手机号" autofocus="autofocus" />
           ...
           <!--  <br/>
			<div style="margin-left:30px"> 
            	...
            	<span >验证码:</span> 
          		<input type="text" id="telCode" style="margin-left:48px" required="required" placeholder="请输入手机验证码" />
            </div> -->
        </div>
        <div class="reg-userinfo">
        	<p style="font-size:16px; color:#999">填写用户资料:</p>    
             <div style="width:100%; height:2px; background:#ccc;"></div> 
            <div class="reg-userinfo-firmname"> 
            	<p style="width:25%; height:70%;float:left;text-align:right">企业名称:</p>
            	<input type="text" name="companyName" />
            </div>
          
            <div class="reg-userinfo-firmaddress">   
            	<p style="width:25%; height:70%;float:left;text-align:right">所在地址:</p>
                <div class="city">
					<div id="selectbox1" class="reg-address-select" ></div>
				</div>
            </div>
            
            <div class="reg-userinfo-firmaddress2">   
            	<p style="width:25%; height:70%;float:left;text-align:right">详细地址:</p>
            	<input type="text" id="address" name="address"/>
            </div>
        </div>
        <div class="reg-setpassword">
        	<p style="font-size:16px; color:#999">设置密码:</p>    
            <div style="width:100%; height:2px; background:#ccc;"></div>  
            <div class="reg-setpassword-username">   
            	<p style="width:25%; height:70%;float:left;text-align:right">用户名:</p>
            	<input type="text" id="username" name="username" style="required="required" placeholder="请输入用户名" />
            </div>
          
			<div class="reg-setpassword-pwd">   
            	<p style="width:25%; height:70%;float:left;text-align:right">密码:</p>
            	<input id="password" type="password" name="password" style=" required="required" placeholder="请输入密码" />
            </div>
        </div>
        <div style="width:100%; height:2px; background:#ccc;"></div>  
...
$(function(){
	...
	//注册
	$(".btn_submit").click(function manager_add(){
		var phone=$(".input_tel").val();//手机号码  
		if(phone != ""){
			var reg = /^1[34578]\d{9}$/;
			if(!reg.test(phone)){
		...
		$("#address").val($(".city").find("option:selected").text() + $("#address").val());
		$("#form").submit();
	});
});
</script>
